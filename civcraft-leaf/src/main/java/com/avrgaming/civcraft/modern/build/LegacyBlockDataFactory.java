...
public final class LegacyBlockDataFactory {
    private LegacyBlockDataFactory() {
    }

    public static BlockData create(LegacyBlock legacyBlock) {
        Material material = LegacyMaterialMapper.map(legacyBlock.legacyId(), legacyBlock.legacyData());
        BlockData blockData = material.createBlockData();
        apply(blockData, legacyBlock);
        return blockData;
    }

    private static void apply(BlockData blockData, LegacyBlock legacyBlock) {
